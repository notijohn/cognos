...
git push --all https://notijohn:qw3rty4321!@github.com/notijohn/cognos.git
...
git push https://notijohn:qw3rty4321!@github.com/notijohn/cognos.git %version_id%.%mydate%   
